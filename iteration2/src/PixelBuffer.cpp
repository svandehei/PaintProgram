...
PixelBuffer::PixelBuffer(const PixelBuffer& other) : m_width(other.m_width), m_height(other.m_height), m_backgroundColor(new ColorData(*other.m_backgroundColor))
{
    m_pixels = new ColorData[m_width * m_height];
    copyPixelBuffer(&other, this);
}
